...
class Test_TwoSharpImageEventRecurrentRestorationModel(BaseModel):
    """Base Event-based deblur model for recurrent image deblur and interpolation."""

    def __init__(self, opt):
        super(Test_TwoSharpImageEventRecurrentRestorationModel, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        pred = self.net_g(x = self.lq, event = self.voxel)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger,
        ...
        if len(dataloader) == 0:
            print('ERROR: The length of dataset is 0!!')
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            # print('DEBUG: imgs_per_iter:{}'.format(imgs_per_iter))

            for frame_idx in range(visuals['result'].size(1)):
                # print('DEBUG: index:{}'.format(self.origin_index))
                ...
                if save_img:
                    ...
                    if self.opt['is_train']:
                        ...
                        save_gt_img_path = osp.join(
                            self.opt['path']['visualization'], dataset_name, self.seq_name,
                            f'{img_name}_gt.png')
                        # print('DEBUG: save_img_path:{}'.format(save_img_path))
