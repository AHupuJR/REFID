...
class UNetDecoderRecurrentSiameseImgNoAtten(DecoderRecurrentAttenResidualUNet):
    """
    ...
    def __init__(self, img_chn, ev_chn, out_chn=3, skip_type='sum',
        ...
        super(UNetDecoderRecurrentSiameseImgNoAtten, self).__init__(img_chn, ev_chn, out_chn, skip_type, activation,
    ...
    def forward(self, x, event):
        ...
        for frame_idx in range(0,t):
            ...
            for i, encoder in enumerate(self.encoders):
                ...
                e_cur = e_cur + x_blocks[i][0] + x_blocks[i][1]
