...
class UNetDecoderRecurrentBidirection(DecoderRecurrentUNet):
    """
    ...
    def __init__(self, img_chn, ev_chn, out_chn=3, skip_type='sum',
        ...
        super(UNetDecoderRecurrentBidirection, self).__init__(img_chn, ev_chn, out_chn, skip_type, activation,
